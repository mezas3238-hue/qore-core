...
This is deliberately not the R3.17 BANK/ATTACK research policy.  It is a narrow
runtime projection of the CIBO capability that was independently certified in
R3.15: the three retained markets, exact methodology fingerprint, and exact
Risk-policy fingerprint may pass through unchanged or be denied.  CIBO cannot
mint capital authority and cannot alter entry/stop/target geometry here.
"""
...
R315_CIBO_VERSION = "r3.15-certified-capability-only-v1"
...
def cibo_policy_fingerprint() -> str:
    material = {
        ...
        "posture": "certified-capability-pass-through-or-deny",
        "capital_authority": False,
        "r3_17_bank_attack_promoted": False,
    }
    return sha256(
        json.dumps(
            material,
...
def evaluate_vt08_forex_cibo(
    ...
    *,
    ...
    """Pass the certified setup unchanged or deny it; never resize or reroute it."""
    ...
    if now > setup.expires_at:
        ...
        reason = "r3.15-certified-capability-pass-through"
