"""VT-08 Forex family contract over the shared source-faithful H4 PO3 kernel.

Forex session policy, allowlist and daily execution cardinality are intentionally
separate from VT-08 Futures.  The shared kernel remains the conservative source
reconstruction and still fails closed where source execution geometry is not
resolved.
"""
...
AUTHORIZED_H4_ANCHOR_HOURS_NEW_YORK = (1, 5, 9)
...
class VT08ForexTrader:
    """Independent Forex authority wrapper; no futures market can pass it."""
