...
def utc_triplet_windows_for_local_date(
    ...
    return tuple(
        CrtPureH4TripletWindow(
            ...
            candle_1_open=window.candle_1_open.astimezone(UTC),
            candle_2_open=window.candle_2_open.astimezone(UTC),
            candle_3_open=window.candle_3_open.astimezone(UTC),
            window_close=window.window_close.astimezone(UTC),
        )
