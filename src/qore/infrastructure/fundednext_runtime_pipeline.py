"""Frozen VT-08 B01 -> CIBO operational translation for the live Forex runtime."""
...
def cibo_setup_from_b01(candidate: Vt08B01Candidate) -> Vt08ForexCiboSetup:
    """Translate only the exact certified B01 fingerprint; never reinterpret geometry."""
    ...
    side = (
        "long" if candidate.side is DemoTradingSetupSide.LONG else "short"
    )
    material = {
...
def request_cibo_posture(
    *,
    ...
    """Request posture only; sovereign Risk still decides ALLOW/REDUCE/REJECT."""
