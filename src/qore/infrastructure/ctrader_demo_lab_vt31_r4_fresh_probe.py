"""One-shot historical cTrader DEMO collector for frozen VT-31 R4 fresh evidence."""
...
FRESH_END_AT = datetime(2024, 8, 15, tzinfo=UTC)
FRESH_LOOKBACK_DAYS = 760


def main() -> None:
    """Acquire the predeclared historical tranche without broker mutation."""
