"""R35 GBPUSD R32-regime core plus corrective structural expansion.

R35 promotes the strongest consumed-development causal core found in R32: REGIME_ROUTE_TYPES. R33/R34 family forensics are used only as expansion when that R32 core abstains. The falsified H4-opposed family and unstable MID_CISD family remain excluded. Additional trades are admitted
only when R32 REGIME_ROUTE_TYPES abstains and the setup belongs to one of a small set of
...
IDENTITY = "TURTLE_SOUP_GBPUSD_R35_R32_CORE_EXPANSION_LAB_V1"
...
def _choose(
    *,
    ...
    return Decision(
        ...
        classification="R35_FORENSICS_CORRECTED_SUBFAMILY",
        observations=int(FAMILY_DEV_EVIDENCE[family]["rank1_10y_n"]),
        source="R35_STRUCTURAL_EXPANSION",
        family=family,
    )
    ...
    return {
        ...
        "forensics": {
            "by_source": {
                ...
                for source in ("R32_REGIME_CORE", "R35_STRUCTURAL_EXPANSION")
            },
            "by_family": {
...
def run(
    ...
    payload = {
        "schema": "qore.turtle_soup_gbpusd.r35_r32_core_expansion.v1",
        "identity": IDENTITY,
        "window": {
        ...
        "governance": {
            ...
            "r33_r34_results_used_for_family_forensics_only": True,
            "fresh_holdout_consumed": False,
            "demo_eligible": False,
    ...
    (output / "r35-r32-core-expansion-report.json").write_text(
