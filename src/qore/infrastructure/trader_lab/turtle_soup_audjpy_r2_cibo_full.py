"""AUDJPY Turtle Soup R2 modeled from CIBO pre-entry market intelligence.
...
IDENTITY = "TURTLE_SOUP_AUDJPY_R2_CIBO_FULL_CONTEXT"
SYMBOL = "AUDJPY"
SOURCE_RUN_ID = 35166210458
SOURCE_ARTIFACT_ID = 10476530915
SOURCE_ARTIFACT_DIGEST = "sha256:b68e74b2afa54295f891c11cde19e12e92db4192930496036c7ebb372474e415"
...
def _fit_model(rows: Sequence[tuple[ContextSignal, r1.Trade]]) -> dict[str, Any]:
    ...
    return {
        "schema": "qore.turtle_soup_audjpy_r2.model.v1",
        "identity": IDENTITY,
...
def run(source_root: Path, output: Path) -> dict[str, Any]:
    ...
    if evidence.symbol != SYMBOL or provenance["retained_bars"] != 745468:
        raise ValueError("unexpected AUDJPY CIBO corpus")
    ...
    payload = {
        "schema": "qore.turtle_soup_audjpy_r2.cibo_full_context_replay.v1",
        "identity": IDENTITY,
        "symbol": SYMBOL,
