"""R28 Turtle Soup XAUUSD — structurally defined, economically validated brain."""
...
IDENTITY = "TURTLE_SOUP_XAUUSD_R28_VALIDATED_SPECIALIST_BRAIN_V1"
...
def run(
    ...
    memory_report = json.loads(
        _single(
            cognitive_root,
            "turtle-soup-xauusd-specialist-cognitive-memory-v3-report.json",
        ).read_text()
    )
    ...
    payload = {
        "schema": "qore.turtle_soup_xauusd_r28.validated_specialist_brain.v1",
        "identity": IDENTITY,
        "window": {
