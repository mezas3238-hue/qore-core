...
MATRIX_IDENTITY = (
    "QORE_CAPITALIZER_NINE_MARKET_OWNER_H1_M5_M3_ANTICIPATION_STATE_ANTICIPATION_STATE_1Y_V2"
)
ENTRY_IDENTITY = "H1_BIAS__SWEEP_SESSION_STATE__M5_CISD_MSS__H1_ANTICIPATION_TSPOT__M3_IFVG_CISD_OBFVG_FVG"
...
def build_matrix(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "architecture": "H1_BIAS_TO_SWEEP_SESSION_STATE_TO_M5_CISD_MSS_TO_H1_ANTICIPATION_TSPOT_TO_M3",
