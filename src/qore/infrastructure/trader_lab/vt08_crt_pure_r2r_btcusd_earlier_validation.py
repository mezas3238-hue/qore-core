"""R2-R earlier BTCUSD validation for the two R2-P survivors.
...
Definitions and R2-J research gate are unchanged. Candidate combination is
forbidden. The 2017-2018 BTC history is intentionally left unconsumed.
"""
...
IDENTITY = "VT08_CRT_PURE_R2R_BTCUSD_EARLIER_VALIDATION_001"
SCHEMA = "qore.vt08.crt_pure.r2r_btcusd_earlier_validation.v1"
...
BINDING: dict[Candidate, CandidateId] = {
    ...
    Candidate.BTC_BEARISH: CandidateId.BTC_BEARISH,
    Candidate.BTC_REF2_PLUS: CandidateId.BTC_REF2_PLUS,
}
...
def run_validation() -> tuple[
    ...
    report: dict[str, Any] = {
        ...
        "final_fresh_2017_2018_preserved": True,
        "research_only": True,
...
def main() -> None:
    ...
    print("CRT_R2R_BTC_VALIDATION_JSON=" + json.dumps(report, sort_keys=True))
