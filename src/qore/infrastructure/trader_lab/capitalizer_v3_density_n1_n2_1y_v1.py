"""V3 density test D1: extend MSS search from H1 N+1 through H1 N+2."""
...
IDENTITY = "QORE_CAPITALIZER_V3_DENSITY_N1_N2_1Y_V1"
MATRIX_IDENTITY = "QORE_CAPITALIZER_NINE_MARKET_V3_DENSITY_N1_N2_1Y_V1"
ENTRY_IDENTITY = (
    "H1_SWEEP__M5_CLOSEBACK__M3_MSS_CISD_ATR_N1_OR_N2__"
...
class V3MarketReport:
    ...
    m3_body_ratio_min: str = "0.60"
    m3_atr_multiplier: str = "1.2"
    mss_window_mode: str = "H1_N1_OR_N2"
    mss_window_hours: int = 2
...
def _scan_day(
    *,
    ...
    seen_entry_keys: set[tuple[datetime, str]] = set()
...
def _load_reports(root: Path) -> list[dict[str, Any]]:
    paths = sorted(
        root.rglob(
            "capitalizer-*-v3-density-n1-n2-1y-v1.json"
        )
    )
    if len(paths) != 9:
...
def build_matrix(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "architecture": (
            "H1_SWEEP_TO_M5_CLOSEBACK_TO_M3_MSS_N1_OR_N2_TO_"
            "M1_CAUSAL_OB_FVG"
        ),
