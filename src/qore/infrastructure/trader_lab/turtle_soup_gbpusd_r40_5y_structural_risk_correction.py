"""GBPUSD R40 — structural risk correction of the frozen R39 five-year trade set.
...
IDENTITY = "TURTLE_SOUP_GBPUSD_R40_5Y_STRUCTURAL_RISK_CORRECTION_V1"
...
OVERLAYS: dict[str, dict[str, Decimal | str]] = {
    ...
    "R40_FRAGILITY_075_050_025": {
        "short": Decimal("0.75"),
        "f5": Decimal("0.75"),
        "majority": Decimal("0.75"),
        "rank2": Decimal("0.75"),
        "combine": "COUNT_075_050_025",
    },
}
...
def run(source_root: Path, output: Path) -> dict[str, Any]:
    ...
    (output / "r40-5y-correction-report.json").write_text(
