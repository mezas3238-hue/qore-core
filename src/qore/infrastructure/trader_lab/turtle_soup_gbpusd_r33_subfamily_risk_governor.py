...
R33 preserves R30 as the high-authority core. GBPUSD family definitions are frozen from its own consumed rank-1 forensics, not inherited from EURUSD.  Additional trades are admitted
...
IDENTITY = "TURTLE_SOUP_GBPUSD_R33_SUBFAMILY_RISK_GOVERNOR_LAB_V1"
...
FAMILY_SETS: dict[str, tuple[str, ...]] = {
    "R33_G123": (F1, F2, F3),
    "R33_G456": (F4, F5, F6),
    "R33_G12345": (F1, F2, F3, F4, F5),
    "R33_G123456": (F1, F2, F3, F4, F5, F6),
}
...
def run(
    ...
    payload = {
        "schema": "qore.turtle_soup_gbpusd.r33_subfamily_risk_governor.v1",
        "identity": IDENTITY,
        "window": {
