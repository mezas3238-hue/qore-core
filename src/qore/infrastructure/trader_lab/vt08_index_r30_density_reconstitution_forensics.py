"""VT08 Index R30 — density reconstitution forensics under Owner Contract V2.
...
R30 asks where valid VT08 density exists before any new rule is invented:
...
SCHEMA = "qore.trader_lab.vt08_index_r30_density_reconstitution_forensics.v1"
IDENTITY = "VT08_INDEX_R30_DENSITY_RECONSTITUTION_FORENSICS_001"
DIAGNOSTIC_TARGETS = (
    Decimal("1.5"),
    Decimal("2.0"),
    Decimal("2.5"),
