"""EURUSD Turtle Soup R2 modeled from CIBO pre-entry market intelligence.
...
IDENTITY = "TURTLE_SOUP_EURUSD_R2_CIBO_FULL_CONTEXT"
SYMBOL = "EURUSD"
SOURCE_RUN_ID = 35166210458
SOURCE_ARTIFACT_ID = 10475354631
SOURCE_ARTIFACT_DIGEST = "sha256:e0fa9e316b79ba61c338161a57508359d4c6afe2fbf97d3f50f1e27c2d359a86"
...
def _fit_model(rows: Sequence[tuple[ContextSignal, r1.Trade]]) -> dict[str, Any]:
    ...
    return {
        "schema": "qore.turtle_soup_eurusd_r2.model.v1",
        "identity": IDENTITY,
...
def run(source_root: Path, output: Path) -> dict[str, Any]:
    ...
    if evidence.symbol != SYMBOL or provenance["retained_bars"] != 707716:
        raise ValueError("unexpected EURUSD CIBO corpus")
    ...
    payload = {
        "schema": "qore.turtle_soup_eurusd_r2.cibo_full_context_replay.v1",
        "identity": IDENTITY,
        "symbol": SYMBOL,
