"""R2-AB historical validation of the AUDUSD one-day-efficiency regime.
...
IDENTITY = "VT08_CRT_PURE_R2AB_AUDUSD_EFF1D_EARLIER_001"
SCHEMA = "qore.vt08.crt_pure.r2ab_audusd_eff1d_earlier.v1"
...
FOLD = datetime(2017, 9, 21, 0, 0, tzinfo=UTC)
...
def main() -> None:
    ...
    print("CRT_R2AB_AUDUSD_VALIDATION_JSON=" + json.dumps(report, sort_keys=True))
