...
from qore.infrastructure.trader_lab import (
    turtle_soup_gbpusd_r28_validated_specialist_brain as r28,
)
from qore.infrastructure.trader_lab import (
...
IDENTITY = "TURTLE_SOUP_GBPUSD_R29_COVERAGE_EXPANSION_LAB_V1"
...
def run(
    ...
    payload = {
        "schema": "qore.turtle_soup_gbpusd.r29_coverage_expansion_lab.v1",
        "identity": IDENTITY,
        "window": {
