...
def test_residual_atlas_requires_all_collision_policies(
    ...
    report = residual.build_report(rebase_root, cross_root, collision_root)

    assert report["control_trades"] == 5
    assert report["third_slot_reference_trades"] == 1
