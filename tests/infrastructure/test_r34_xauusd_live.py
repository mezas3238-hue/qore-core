...
def test_r34_anchor_is_hourly_and_hard_two_second_grace() -> None:
    assert current_anchor(
        datetime(2026, 9, 18, 5, 0, 1, 900_000, tzinfo=UTC)
    ) == datetime(2026, 9, 18, 5, 0, tzinfo=UTC)
    assert current_anchor(
        datetime(2026, 9, 18, 5, 0, 2, 1_000, tzinfo=UTC)
    ) is None
