"""Physical DOL1 retrace execution binding for certified VT31 NAS100.
...
def _physicalize(
    ...
    *,
    ...
    for row in path_rows:
        ...
        # back through DOL1, so the quarter-leg can exit causally at DOL1.
        # Only the additional child execution friction differs from certified
        # accounting.
        delta = -EXTRA_PHYSICAL_CLOSE_FRICTION_R
        ...
        updated["physical_dol1_nonaccept_close_r"] = format(dol1_r, "f")
