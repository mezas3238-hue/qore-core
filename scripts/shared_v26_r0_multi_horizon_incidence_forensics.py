"""V26-R0 multi-horizon cumulative-incidence forensics for Shared Core.
...
IDENTITY = "QORE_SHARED_V26_R0_MULTI_HORIZON_INCIDENCE_FORENSICS"
SCHEMA = "qore.shared.v26_r0_multi_horizon_incidence_forensics"
...
def _window(
    *,
    ...
    survival_vetoed: dict[int, dict[str, Any]] = {}
    ...
    for survival_probability, item in zip(
        ...
        if float(survival_probability) <= limit:
            ...
            survival_vetoed[trade_index] = record
