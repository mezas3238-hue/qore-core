"""One-shot historical cTrader DEMO collector for frozen VT-31 R6 evidence."""
...
FRESH_END_AT = datetime(2020, 6, 17, tzinfo=UTC)
...
def main() -> None:
    ...
    try:
        ...
        payload.update(
            {
                "evidence_purpose": "VT31_R6_ONE_SHOT_FRESH_VALIDATION",
