"""Acquire BID/ASK ticks for the 50 unresolved R5 high-density minutes.
...
Only the exact missing windows are queried. No new dates are discovered and no
...
def _load_manifest(path: Path) -> dict[str, Any]:
    ...
    for row in windows:
        ...
        if row.get("partition") != "r5":
            raise CTraderDemoLabProbeError("only R5 is authorized")
